   ...
   <div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left" id="">
            <h2 class="well text-center"><b>Delete Record of Buyer</b></h2>
              <?php       
                    $id=$_POST['buyer_id'];
                    // Create connection
                    $db="nazprinters";
                    ...
                    mysql_query("DELETE FROM  buyer where buyer_id=$id")or die("Delete Error: ".mysql_error());
                    mysql_close($link);
                ...
                ?>
                  <div class="form-group"> 
                                    ...
                                    <a href="update-buyer.php">  <button class="btn btn-default" type="submit">Delete</button></a> 
