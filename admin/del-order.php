   ...
   <div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left" id="">
            <h2 class="well text-center"><b>Delete Record of Order</b></h2>
      <?php       
            ...
            mysql_query("DELETE FROM  orders where order_code=$order_code")or die("Delete Error: ".mysql_error());
            mysql_close($link);
            print "Record Removed.";
        ?>
                  <div class="form-group"> 
                                    <div class="col-sm-offset-2 col-sm-10">
                                    <a href="update-order.php">  <button class="btn btn-default" type="submit">Delete</button></a> 
