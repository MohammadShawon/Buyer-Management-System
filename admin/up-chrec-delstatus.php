    ...
    <div class="row content">
        ...
        <div class="col-sm-8 text-left" id="">
            ...
            $udel_no=$_POST['udel_no'];
                ...
                $sql = "UPDATE delivery SET delivery_id='$udel_no',order_code='$uorder_code',status='$ustatus', remarks='$uremark' WHERE delivery_id='$udel_no'";
        ...
        <div class="form-group"> 
            <form class="form-horizontal" role="form" method="POST" action="update-del-status.php" enctype="multipart/form-data">
                        <div class="col-sm-offset-2 col-sm-10">
                                  <a href="update-del-status.php">    <button class="btn btn-default" type="submit">Update</button></a> 
                        </div>
            </form>
                                  </div>
        </div>
