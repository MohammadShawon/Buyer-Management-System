...
<div class="container-fluid text-center">
    <div class="row content" id="content">
        <div class="col-sm-2 sidenav">
            <aside class="well">
             <a href="add-buyer.php"> <button  class="btn btn-primary btn-md" type="button">Go Back</button></a> 
                <ul>
       ...
       <div class="col-sm-8 common text-center well " id="">
                ...
                $sql=mysql_query("INSERT INTO $tbl_name VALUES('$id', '$buyer_name','$company','$email', '$phone','$$address')");
                ...
                echo "<BR>";
                echo " <a href='add-buyer.php'>Add Another</a>";
                echo "<BR>";
